...
![Starter Article Reader](https://github.com/walkingtree/images/blob/master/sencha/allaboutgrids/starterarticlereader.png)

Clicking on the **Edit** button shows the Edit Window, which has a Form loaded with the selected record.

![Edit Window](https://github.com/walkingtree/images/blob/master/sencha/allaboutgrids/editwindow.png)
...
![Grids UML](https://github.com/walkingtree/images/blob/master/sencha/allaboutgrids/GridsUML.png)
...
* Save your work and refresh the application. Select the **Grid** tab and expand any group. You should see the following screen.
  ...
  ![Grouping Grid](https://github.com/walkingtree/images/blob/master/sencha/allaboutgrids/grouping.png)
