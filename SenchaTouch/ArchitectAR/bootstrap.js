...
Ext.ClassManager.addNameAlternateMappings({
  "AR.controller.Article": [],
  "AR.controller.Author": [],
  "AR.controller.Category": [],
  "AR.controller.Main": [],
  "AR.locale.ChooseLabels": [],
  "AR.locale.Labels": [],
  "AR.model.Article": [],
  "AR.model.ArticleLocal": [],
  "AR.model.Author": [],
  "AR.model.Category": [],
  "AR.model.Categorytree": [],
  "AR.model.Setting": [],
  "AR.override.Menu": [],
  "AR.store.ArticleStore": [],
  "AR.store.Author": [],
  "AR.store.Category": [],
  "AR.store.CategoryTreeStore": [],
  "AR.store.LocalArticle": [],
  "AR.store.Setting": [],
  "AR.store.override.Setting": [],
  "AR.util.Utility": [],
  "AR.view.Main": [],
  "AR.view.Navigation": [],
  "AR.view.OverFlowMenu": [],
  "AR.view.Setting": [],
  "AR.view.Tabpanel": [],
  "AR.view.article.Detail": [],
  "AR.view.article.List": [],
  "AR.view.author.IconView": [],
  "AR.view.category.IconView": [],
  "AR.view.category.TreeView": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "AR.view.author.IconView": [
    "widget.authorIconView"
  ],
  "AR.view.category.IconView": [
    "widget.categoryIconView"
  ],
  "AR.view.category.TreeView": [
    "widget.categoryTreeView"
  ],
  "AR.view.override.Setting": [
    "widget.settingsform"
  ],
