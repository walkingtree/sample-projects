...
Ext.define('Ext.viewport.Default', {
    ...
    constructor: function(config) {
      ...
      // set default devicePixelRatio if it is not explicitly defined
        ...
        me.on('ready', me.onReady, me, {single: true});
    ...
    initialize: function() {
        ...
        if (window.navigator.standalone) {
            me.addMeta('viewport', 'width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0');
        } else {
            me.addMeta('viewport', 'initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, minimum-ui');
        }
