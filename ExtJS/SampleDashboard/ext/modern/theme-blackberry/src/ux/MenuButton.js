 ...
 * @private
 */
Ext.define('TouchThemeBlackberry.ux.MenuButton', {
    extend: 'Ext.Button',
    requires: ['TouchThemeBlackberry.ux.ContextMenu'],
    ...
    onTap: function(e) {
        ...
        this.$menu = Ext.create('TouchThemeBlackberry.ux.ContextMenu', Ext.apply({}, this.getMenuConfig(), {
            cls: this.getMenuCls(),
