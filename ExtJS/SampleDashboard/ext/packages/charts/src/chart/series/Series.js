...
Ext.define('Ext.chart.series.Series', {
    ...
    applyTooltip: function (tooltip, oldTooltip) {
        ...
        // Tooltips can't work without the 'itemhighlight' or 'itemedit' interaction,
        // so we add one if it doesn't exist.
        for (i = 0; i < interactions.length; i++) {
            type = interactions[i].type;
            if (type === 'itemhighlight' || type === 'itemedit') {
