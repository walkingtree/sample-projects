...
Ext.define('Ext.chart.series.sprite.Pie3DPart', {
            ...
            updaters: {
                        ...
                        case 'top':
                            fillStyle = new Ext.draw.gradient.Radial({
                                ...
                                stops: [
                                    {
                                        offset: 0,
                                        color: color.createLighter(0.1)
                                    },
                                    {
                                        offset: 1,
                                        color: color.createDarker(0.1)
                                    }
                                ]
                            });
                            break;
                        ...
                        case 'outerBack':
                            fillStyle =  new Ext.draw.gradient.Linear({
                                stops: [
                                    {
                                        offset: 0,
                                        color: color.createDarker(0.15).toString()
                                    },
                                    {
                                        offset: 0.3,
                                        color: colorString
                                    ...
                                    {
                                        offset: 1,
                                        color: color.createDarker(0.25).toString()
                                    }
                                ]
                            });
                            break;
                        case 'start':
                            fillStyle = new Ext.draw.gradient.Linear({
                                stops: [
                                    {
                                        offset: 0,
                                        color: color.createDarker(0.1).toString()
                                    },
                                    {
                                        offset: 1,
                                        color: color.createLighter(0.2).toString()
                ...
                partZIndex: function (attr) {
                    var rotation = attr.baseRotation,
                        midAngle = (attr.startAngle + attr.endAngle) / 2,
                    ...
                    switch (attr.part) {
                        ...
                        case 'outerBack':
                            ...
                            break;
                        case 'start':
                            attr.zIndex = 3 + Math.sin(attr.startAngle + rotation);
                            break;
                        case 'end':
                            attr.zIndex = 3 + Math.sin(attr.endAngle + rotation);
                            break;
                        case 'innerFront':
                            attr.zIndex = 2;
                            break;
    ...
    bevelRenderer: function (surface, ctx) {
        ...
        for (i = 0; i < params.length; i++) {
            ...
            ctx.lineWidth = width;
            ctx.strokeOpacity = width ? 1 : 0;
            ctx.strokeGradient = me.bevelGradient;
            //ctx.strokeStyle = me.bevelGradient.generateGradient(ctx, this.getBBox(attr.transformFillStroke));
            ctx.stroke(attr);
            ctx.restore();
