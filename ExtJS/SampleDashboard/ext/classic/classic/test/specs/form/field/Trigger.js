...
describe("Ext.form.field.Trigger", function() {
    ...
    describe("trigger hiding", function() {
        describe("hideTrigger config", function() {
            ...
            it("should not hide the trigger elements when set to false, except second trigger", function() {
                makeComponent({
                    hideTrigger: false,
                    id      : 'foo-field',
                    renderTo: Ext.getBody(),
