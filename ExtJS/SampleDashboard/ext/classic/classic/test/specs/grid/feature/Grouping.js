describe('Ext.grid.feature.Grouping', function () {
    ...
    describe('stateful', function () {
        ...
        function checkState(groupField, dir) {
        ...
        describe('when groupField is defined', function () {
            it('should maintain the grouping', function () {
                checkState('student');
            });

            it('should maintain the sort direction', function () {
                checkState('mark', 'DESC');
            });
        });

        describe('when groupField is not defined', function () {
            it('should maintain the grouping', function () {
                checkState(null);
            });

            it('should maintain the sort direction', function () {
                checkState(null, 'DESC');
            });
        });
