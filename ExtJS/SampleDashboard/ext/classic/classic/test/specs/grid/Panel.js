...
//            waits(1);
    ...
    xdescribe('statefulness', function() {
        var rawData = [
        ...
        describe('loading/reloading', function () {
            ...
            // remote sorting and grid filters.  See EXTJSIV-10029.
            var wasCalled = false;
        ...
        describe('should not make more than one network request', function () {
        ...
        describe('should not make a network request when autoLoad is false', function () {
