describe("grid-general", function() {
        ...
        describe(buffered ? "with buffered rendering" : "without buffered rendering", function() {
            ...
            describe("autoSizeColumn", function() {
                ...
                it("should size the column when passed a header", function() {
                    ...
                    expect(colRef[0].getWidth()).toBe(450 + getPadding());
                });
            ...
            describe("locking columns", function(){
                testIt("should synchronize horizontal scrollbar presence between locked and normal side.", function(){
                    var indexes = [],
                        fn = function(){
                            indexes.push(arguments[4]);
                        };
    ...
    describe('BufferedStore asynchronous loading timing with rendering', function() {
        var view,
            bufferedRenderer,
            scroller,
            scrollSize,
        ...
        it('should refresh the same rendered block on buffered store reload', function() {
            var scrollDone,
                refreshed,
                startRow, endRow;
