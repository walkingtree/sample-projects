    ...
    describe("tabbables", function() {
        ...
        describe("finding", function() {
            ...
            describe("children", function() {
                ...
                beforeEach(function() {
                    els = el.findTabbableElements(/* skipSelf = */ true);
                });
            ...
            describe("excludeRoot", function() {
                ...
                beforeEach(function() {
                    test1 = Ext.get('test1');
                    els = el.findTabbableElements(true, false, test1);
                });
            ...
            function createSuite(name, elConfig, selector, deep) {
                return describe(name, function() {
                    ...
                    describe("saving", function() {
                        beforeEach(function() {
                            el.saveTabbableState(false, !deep);
                        });
                ...
                return describe(name, function() {
                    describe(name + " saving", function() {
                        ...
                        describe(name + " element", function() {
                            beforeEach(function() {
                                el.saveTabbableState(/* skipSelf = */ false, /* skipChildren = */ true);
                            });
                            ...
                            if (deep) {
                                it("should not disable children tabbable state", function() {
                                    var cn = el.findTabbableElements(/* skipSelf = */ true);
                        ...
                        if (deep) {
                            describe(name + " children", function() {
                                beforeEach(function() {
                                    el.saveTabbableState(/* skipSelf = */ true, /* skipChildren = */ !deep);
                                });
                            
                                it("should remove children from tab order", function() {
                                    var cn = el.findTabbableElements(true);
                    ...
                    describe(name + " restoring", function() {
                        ...
                        if (deep) {
                            describe(name + " children saved", function() {
                                beforeEach(function() {
                                    saved = el.saveTabbableState(/* skipSelf = */ true, !deep) || [];
                                });
        ...
        describe("an element", function() {
            ...
            describe("when masked", function() {
                ...
                it("should save its children tabbable states", function() {
                    var tabbables = el.findTabbableElements(/* skipSelf = */ true);
            ...
            describe("when unmasked", function() {
                ...
                it("should restore its children tabbable state", function() {
                    var tabbables = el.findTabbableElements(true);
