...
//    }],
    ...
    renderTpl: [
        '<div id="{id}-titleEl" data-ref="titleEl" role="presentation"',
            ...
            //
            '<span id="{id}-textContainerEl" data-ref="textContainerEl" role="presentation" class="', Ext.baseCSSPrefix, 'column-header-text-container">',
                '<span role="presentation" class="', Ext.baseCSSPrefix, 'column-header-text-wrapper">',
                    '<span id="{id}-textEl" data-ref="textEl" role="presentation" class="', Ext.baseCSSPrefix, 'column-header-text',
                        '{childElCls}">',
                        '{text}',
                    '</span>',
                '</span>',
     ...
     *     });
     * 
     * @param {HTMLElement} cell The HTML cell element to update.
     * @param {Object} value The data value for the current cell
     * @param {Ext.data.Model} record The record for the current row
