...
Ext.define('Ext.grid.CellEditor', {
    ...
    beforeItemUpdate: function(record, recordIndex, oldItemDom) {
        if (Ext.fly(oldItemDom).contains(this.el)) {
            this.needsFixOnItemUpdate = true;
            this.beforeViewRefresh(this.editingPlugin.view);
        }
    },
