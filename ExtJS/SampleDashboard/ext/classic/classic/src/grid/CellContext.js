...
Ext.define('Ext.grid.CellContext', {
     ...
     *
     * @returns {Ext.grid.CellContext} this CellContext object.
     */
     ...
     * @returns {HtmlElement/Ext.dom.Element} The cell referenced by this context.
     */
     ...
     *
     * @param {Boolean} returnDom Pass `true` to return a DOM object instead of an {@link Ext.dom.Element Element).
     * @returns {HtmlElement/Ext.dom.Element} The grid row referenced by this context.
     */
     ...
     *
     * @param {Boolean} returnDom Pass `true` to return a DOM object instead of an {@link Ext.dom.Element Element).
     * @returns {HtmlElement/Ext.dom.Element} The grid item referenced by this context.
     */
     ...
     * @returns {Boolean} `true` if the other cell context references the same cell as this.
     */
     ...
     * @returns {Ext.grid.CellContext} A copy of this context, referencing the same cell.
     */
    clone: function() {
        var me = this,
