    ...
    fieldSubTpl: [
        '<div id="{cmpId}-innerWrapEl" data-ref="innerWrapEl" role="presentation"',
            ...
            '<tpl if="labelAlignedBefore">',
                ...
                '{afterBoxLabelTpl}',
            '</tpl>',
            '<input type="button" id="{id}" data-ref="inputEl" {inputAttrTpl}',
                '<tpl if="tabIdx != null"> tabindex="{tabIdx}"</tpl>',
                '<tpl if="disabled"> disabled="disabled"</tpl>',
                '<tpl if="fieldStyle"> style="{fieldStyle}"</tpl>',
                ' class="{fieldCls} {typeCls} {typeCls}-{ui} {inputCls} {inputCls}-{ui} {childElCls} ',
                ' {afterLabelCls}" autocomplete="off" hidefocus="true" ',
