    ...
    */
    ...
    onFocusEnter: function(e) {
        ...
        if (!me.cellFocused && me.all.getCount() && me.dataSource.getCount()) {
            ...
            // This means that we must be in actionable mode.
    ...
    handleUpdate: function(store, record, operation, changedFieldNames) {
        ...
        if (me.viewReady) {
            ...
            if (oldItemDom) {
                ...
                me.fireEvent('beforeitemupdate', record, recordIndex, oldItemDom);
    ...
    privates: {
            ...
            if (enabled) {
                if (position && (position.view === me || (position.view === (lockingPartner = me.lockingPartner) && lockingPartner.actionableMode))) {
                    ...
                    if (lockingPartner || focusCell.restoreTabbableState(/* skipSelf */ true).length || isActionable) {
                        ...
                        // Tell all registered Actionables about this fact.
                        for (i = 0; i < len; i++) {
                ...
                if (me.actionRow) {
                    me.actionRow.saveTabbableState(/* skipSelf = */ true, /* skipChildren */ false, /* excludeRoot */ false, /* includeSaved */ false);
                }
        ...
        onRowExit: function(prevRow, newRow, forward) {
            ...
            Ext.fly(prevRow).saveTabbableState(/* skipSelf = */ true, /* skipChildren */ false, /* excludeRoot */ false, /* includeSaved */ false);
        },
