...
Ext.define('Ext.overrides.dom.Element', (function() {
    ...
    return {
        ...
        */
        mask: function (msg, msgCls /* private - passed by AbstractComponent.mask to avoid the need to interrogate the DOM to get the height*/, elHeight) {
            ...
            me.saveTabbableState(dom === DOC.body);
        ...
        privates: {
             ...
             * @private
             */
            findTabbableElements: function(skipSelf, skipChildren, excludeRoot, includeSaved) {
                var dom = this.dom,
                ...
                if (!skipSelf &&
                    ((includeSaved && dom.hasAttribute(cAttr)) || this.isTabbable())) {
                    selection[idx++] = dom;
                }
                ...
                for (i = 0; i < len; i++) {
                    ...
                    // decremented.
                    if (((includeSaved && node.hasAttribute(cAttr)) || (!(tabIndex < 0) && fly.attach(node).isTabbable())) &&
             ...
             * @private
             */
            saveTabbableState: function(skipSelf, skipChildren, excludeRoot, includeSaved) {
                ...
                if (includeSaved == null) {
                    includeSaved = true;
                }
                
                nodes = this.findTabbableElements(skipSelf, skipChildren, excludeRoot, includeSaved);
    ...
    if (Ext.isIE8) {
        // save a reference to the removeNode function defined in core
