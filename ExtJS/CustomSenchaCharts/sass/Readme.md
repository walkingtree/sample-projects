...
folder are mapped to the application's root namespace, 'CustomSenchaCharts'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "CustomSenchaCharts"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'CustomSenchaCharts' in the same way
as `"CustomSenchaCharts/sass/src"`.
